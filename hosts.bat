...
echo.
echo. 2 运行Google脚本，使用74.125.224的地址更新Google服务地址
echo.
echo. 3 运行Google脚本，使用74.125.224的地址更新Google服务地址
echo.
echo. 4 运行Google脚本，使用www.g.cn的地址更新Google服务地址
echo.
echo. 5 运行Google脚本，使用www.google.cn的地址更新Google服务地址
echo.
echo. 6 恢复Google顶部的黑色导航栏
echo.
echo. 7 退出
echo.
echo. 8 还原前一个hosts
echo.
echo. 9 Android手机专用的Google服务hosts(Google hosts for Android）
echo.
echo. 0 访问发布页，提出意见并查看hosts的最新更新情况
echo.
